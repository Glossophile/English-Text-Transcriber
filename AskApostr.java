...
public class AskApostr extends JPanel {
    private Font script = new Font("Times New Roman", Font.PLAIN, 17);
    private JLabel instruct;
    public String context;
    public boolean apost = false;
    private Control yes = new Control("APOSTROPHE",true);
    private Control no = new Control("NESTED QUOTE",false);
    ...
    public AskApostr (String environ) {
        context = environ;
        instruct = new JLabel("What is the tick mark in [..."+context+"...]?");
